        ...
        <div className={styles['company-section_content']}>
          ...
          <div>
            ...
            <p>
              ...
              <br />
              <br />
              Мы гордимся тем, что дома, построенные нами, становятся надёжной основой для новых семейных историй. И
              продолжаем двигаться вперёд — с верой, ответственностью и качеством в каждом проекте.
            </p>
          </div>
        </div>
      </section>
